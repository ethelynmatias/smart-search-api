...
class SmartDocRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // How to send the search link to the client (request-from-client flow)
            'notify_method' => ['nullable', 'string', 'in:sms,email'],
            'mobile' => ['required_if:notify_method,sms', 'nullable', 'string', 'max:20'],
            'email' => ['required_if:notify_method,email', 'nullable', 'email', 'max:255'],
        ];
    }
}
